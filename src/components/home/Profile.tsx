...
export default function Profile({ author, social, features, researchInterests }: ProfileProps) {
    ...
    return (
        <motion.div
            ...
            className="sticky top-8 w-full max-w-sm mx-auto lg:max-w-none"
        >
            {/* Profile Image */}
            ...
            <div className="text-center mb-6 px-4 sm:px-0">
                <h1 className="text-3xl font-serif font-bold text-primary mb-2 break-words">
                    {author.name}
                </h1>
                <p className="text-lg text-accent font-medium mb-1">
                    {author.title}
                </p>
                <p className="text-neutral-600 mb-2 leading-relaxed break-words max-w-72 mx-auto">
                    {author.institution}
                </p>
            </div>
            ...
            {researchInterests && researchInterests.length > 0 && (
                <div className="bg-neutral-100 dark:bg-neutral-800 rounded-lg p-4 mb-6 hover:shadow-lg transition-all duration-200 hover:scale-[1.02] max-w-sm mx-auto">
